...
function calculator() {
  ...
  function calcTotal() {
    if (!sex || !height || !weight || !age || !ratio) {
      result.textContent = 'Enter all data';
      return;
    }
...
function cards() {
  //79. используем классы для карточек
  class MenuCard {
...
function forms(formSelector, modalTimerId) {
  ...
  forms.forEach(item => {
    //под каждую фомру подвязываем ф-цию postData
    bindPostData(item);
  });
  ...
  function showThanksModal(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_0__.openModal)('.modal', modalTimerId); //отвечает за открытие модельных окон
...
/* harmony import */ var _modules_calculator__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_modules_calculator__WEBPACK_IMPORTED_MODULE_7__);
(__webpack_require__(/*! es6-promise */ "./node_modules/es6-promise/dist/es6-promise.js").polyfill)();

 //это файл установился в node modules
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  _modules_calculator__WEBPACK_IMPORTED_MODULE_7___default()();
  /* 91) axios.get('http://localhost:3000/menu')
       .then(data => {
